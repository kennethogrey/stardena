                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12 footer-widget">
                        <div class="footer-logo mb-30">
                            <a href="index.html"><img src="{{asset('front/assets/images/stardena_blue.png')}}" alt=""></a>
                        </div>
                        <div class="textwidget pb-30">
                            <p>In the vibrant tapestry of Africa, we envision a digital landscape where
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        ...
                        <p class="widget-desc">Subscribe to our newsletter for updates on our
